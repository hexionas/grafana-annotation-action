...
const utils_1 = __nccwpck_require__(643);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(955);
...
const http_client_1 = __nccwpck_require__(662);
const auth_1 = __nccwpck_require__(548);
const core_1 = __nccwpck_require__(152);
class OidcClient {
...
const pm = __nccwpck_require__(785);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(712);
            }
            const agentOptions = {
...
/* harmony export */ });
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(152);
